...
import { deleteWishItem } from "@/serives/whishList/delete-cart-item copy";
      ...
      {WishListData?.count > 0 ? (
        ...
        <>
          <div className="flex justify-center items-center">
            <Image src={cartimg} width={400} height={400} alt="WishListData" />
          </div>
        </>
      )}
    </>
            ...
            <div className="border p-4">
              <h2 className="text-xl my-4  ">
                ...
                <span className="text-green-400">
                  {WishListData?.numOfCartItems}
                </span>
              </h2>
              <h2 className="text-xl ">
                Total price{" "}
                <span className="text-green-400">
                  {WishListData?.data.totalCartPrice}EGP
                </span>
              </h2>
              <Button className=" my-4">
                <Link href={`/checkout/${WishListData?.cartId}`}>check out</Link>
              </Button>
            </div> */
}
{
